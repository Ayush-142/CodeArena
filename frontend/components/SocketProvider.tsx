...
import { createSocket, type ServerToClientEvents } from '@/lib/socket';
import { useAuth } from './AuthProvider';

const SocketContext = createContext<Socket<ServerToClientEvents> | null>(null);
...
export function SocketProvider({ children }: { children: ReactNode }) {
  ...
  const [connectedSocket, setConnectedSocket] = useState<Socket<ServerToClientEvents> | null>(null);
...
export function useSocket(): Socket<ServerToClientEvents> | null {
