...
export function MarkdownStatement({ statementMd }: { statementMd: string }) {
  return (
    <div className="max-w-none font-body text-ink [&_code]:bg-surface [&_code]:font-mono [&_code]:text-sm [&_h1]:font-display [&_h1]:text-lg [&_h1]:font-bold [&_h2]:font-display [&_h2]:font-bold [&_pre]:border [&_pre]:border-line [&_pre]:bg-surface [&_pre]:p-2 [&_pre]:font-mono [&_pre]:text-sm [&_a]:text-accent [&_a]:underline">
